...
import 'quill/dist/quill.bubble.css'
    ...
    export default {
        ...
        methods: {
            ...
            submitPost() {
                this.$loading()
                if (this.postTitle.trim() && this.editor.root.innerHTML.trim()) {
                    let data = {
                        title: this.postTitle.trim(),
                        content: this.editor.root.innerHTML.trim(),
                        summary: this.editor.getText().trim().slice(0, 80),
                        poster: this.imgUrlFun(this.editor.root.innerHTML.trim()),
